    ...
    public static void main(String[] args)
        {
            ...
            final String name="Brenda Kanani", Roll_No="C026-01-0967/2022", Semester="2.2";
          ...
          //Declaring variable to hold the data to be read from the user
            ...
            if(average >= 70 && average <= 100)
                ...
                grade = '-';            
                        ...
                        //Print the pages Layout and the the entered and computed information.
            //-------------------------------------------------------------------------------
            //The page header.
            ...
            System.out.println("------------------------------------------------------------------------------");
            //closing the reference variable
            //--------------------------------------------------------------------------------
            input.close();
        }
    }
